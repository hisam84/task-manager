                  ...
                  <div>
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute right-1.5 top-1/2 -translate-y-1/2 p-2 rounded-md bg-amber-50 dark:bg-amber-500/10 hover:bg-amber-100 dark:hover:bg-amber-500/20 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-500/20 transition-all flex items-center justify-center cursor-pointer select-none"
                        title="Open Calendar"
                ...
                <div className="sm:col-span-3">
                  ...
                  >
                    <input
                      ...
                      className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 group-hover:border-slate-400 dark:group-hover:border-slate-700 focus:border-indigo-500 rounded-lg pl-3 pr-11 py-2 text-xs text-slate-900 dark:text-white font-mono outline-none transition-colors cursor-pointer hide-native-picker"
                    />
                    <button
                      type="button"
                      onClick={(e) => {
                      ...
                      className="absolute right-1.5 top-1/2 -translate-y-1/2 p-2 rounded-md bg-indigo-50 dark:bg-indigo-500/10 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-500/20 transition-all flex items-center justify-center cursor-pointer select-none"
                      title="Open Calendar"
                      aria-label="Open Calendar"
                    >
                      <Calendar className="w-4 h-4 shrink-0" />
