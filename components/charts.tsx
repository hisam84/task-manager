...
export function DonutChart({ items, totalLabel = "Total Tasks" }: DonutChartProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-6 p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
  ...
  return (
    <div className="flex flex-col gap-4 p-5 rounded-2xl bg-slate-900/60 border border-slate-800/80">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-white">Employee Task Distribution</h3>
            ...
            return (
              <div key={idx} className="flex flex-col gap-1 text-xs">
                <div className="flex justify-between items-center text-slate-300 font-medium">
                  <span className="truncate max-w-[150px] text-white">{item.name}</span>
  ...
  return (
    <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800/80 flex items-center justify-between gap-4">
      <div className="flex flex-col">
        ...
        {subtitle && <span className="text-[11px] text-slate-400 mt-1">{subtitle}</span>}
      </div>
